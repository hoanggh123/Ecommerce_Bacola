            ...
            <div className='sidebar false'>
                <div className='filterBox'>
                    ...
                    <div className='scroll'>
                        <ul>
                            <li>
                                <FormControlLabel className='w-100' control={<Checkbox defaultChecked />} label="Herbs & Seasonings" />
                            </li>
                            <li>
                                <FormControlLabel className='w-100' control={<Checkbox defaultChecked />} label="Herbs & Seasonings" />
                            </li>
                ...
                <div className='filterBox filterPrice'>
                    ...
                    <RangeSlider className="w-75" value={value} onInput={setValue} min={100} max={60000} step={5} />
                    <div className='d-flex pt-2 pb-2 priceRange'>
                        <span className='priceLabel'>From: <strong className='text-success'>Rs: {value[0]}-{value[1]}</strong> </span>
                    </div>
                </div>
